...
- Check for MILESTONE-CONTEXT.md (from /amil:discuss-milestone)
...
**Persist choice to config** (so future `/amil:plan-phase` honors it):
...
Spawn 4 parallel amil-project-researcher agents. Each uses this template with dimension-specific fields:
...
Use template: ~/.claude/amil/templates/research-project/{FILE}
</output>
", subagent_type="amil-project-researcher", model="{researcher_model}", description="{DIMENSION} research")
```
...
`/amil:discuss-phase [N]` — gather context and clarify approach

<sub>`/clear` first → fresh context window</sub>

Also: `/amil:plan-phase [N]` — skip discussion, plan directly
```
...
- [ ] amil-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md phases continue from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step: `/amil:discuss-phase [N]`
