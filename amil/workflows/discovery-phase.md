...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /amil:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/amil/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/amil/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/amil/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/amil/templates/discovery.md
...
Use ~/.claude/amil/templates/discovery.md.
...
1. Discuss phase context (/amil:discuss-phase [current-phase])
2. Create phase plan (/amil:plan-phase [current-phase])
