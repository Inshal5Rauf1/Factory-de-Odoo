...
<required_reading>
@~/.claude/amil/references/verification-patterns.md
@~/.claude/amil/templates/verification-report.md
</required_reading>
...
Use amil-tools to extract must_haves from each PLAN:
...
Use amil-tools for artifact verification against must_haves in each PLAN:
...
Use amil-tools for key link verification against must_haves in each PLAN:
...
See ~/.claude/amil/templates/verification-report.md for complete template.
</step>
