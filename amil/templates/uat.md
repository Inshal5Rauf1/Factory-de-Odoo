...
- This section feeds directly into /amil:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /amil:plan-phase --gaps with root causes
...
**Creation:** When /amil:verify-work starts new session
