...
describe('phases list command', () => {
  ...
  test('empty phases directory returns empty array', () => {
    const result = runAmilTools('phases list', tmpDir);
  ...
  test('--type plans lists only PLAN.md files', () => {
    ...
    const result = runAmilTools('phases list --type plans', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--type summaries lists only SUMMARY.md files', () => {
    ...
    const result = runAmilTools('phases list --type summaries', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--phase filters to specific phase directory', () => {
    ...
    const result = runAmilTools('phases list --type plans --phase 01', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase next-decimal command', () => {
  ...
  test('returns X.1 when no decimal phases exist', () => {
    ...
    const result = runAmilTools('phase next-decimal 06', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('handles single-digit phase input', () => {
    ...
    const result = runAmilTools('phase next-decimal 6', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase-plan-index command', () => {
  ...
  test('empty phase directory returns empty plans array', () => {
    ...
    const result = runAmilTools('phase-plan-index 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
  ...
  test('phase not found returns error', () => {
    const result = runAmilTools('phase-plan-index 99', tmpDir);
    assert.ok(result.success, `Command should succeed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('phase-plan-index 04', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('phase add User Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('handles empty roadmap', () => {
    ...
    const result = runAmilTools('phase add Initial Setup', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('phase insert 1 Fix Critical Bug', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('phase insert 1 Another Fix', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('rejects missing phase', () => {
    ...
    const result = runAmilTools('phase insert 99 Fix Something', tmpDir);
...
`
    ...
    const result = runAmilTools('phase insert 9.05 Padding Test', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('phase insert 5 Hotfix', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    // Remove phase 2
    const result = runAmilTools('phase remove 2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('rejects removal of phase with summaries unless --force', () => {
    ...
    const result = runAmilTools('phase remove 1', tmpDir);
    ...
    const forceResult = runAmilTools('phase remove 1 --force', tmpDir);
  ...
  test('removes decimal phase and renumbers siblings', () => {
    ...
    const result = runAmilTools('phase remove 6.2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('updates STATE.md phase count', () => {
    ...
    runAmilTools('phase remove 2', tmpDir);
...
`
    ...
    const result = runAmilTools('phase complete 1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('phase complete 03.2.1', tmpDir);
...
describe('phase complete milestone-scoped next-phase', () => {
  ...
  test('finds next phase within milestone, ignoring prior milestone dirs', () => {
    ...
    const result = runAmilTools('phase complete 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
