...
describe('history-digest command', () => {
  ...
  test('empty phases directory returns valid schema', () => {
    const result = runAmilTools('history-digest', tmpDir);
...
describe('summary-extract command', () => {
  ...
  test('missing file returns error', () => {
    const result = runAmilTools('summary-extract .planning/phases/01-test/01-01-SUMMARY.md', tmpDir);
...
`
    ...
    const result = runAmilTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md --fields one_liner,key_files,requirements_completed', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('progress command', () => {
  ...
  test('renders JSON progress', () => {
    ...
    const result = runAmilTools('progress json', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders bar format', () => {
    ...
    const result = runAmilTools('progress bar --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders table format', () => {
    ...
    const result = runAmilTools('progress table --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('does not crash when summaries exceed plans (orphaned SUMMARY.md)', () => {
    ...
    const barResult = runAmilTools('progress bar --raw', tmpDir);
    ...
    const tableResult = runAmilTools('progress table --raw', tmpDir);
    assert.ok(tableResult.success, `Table format crashed: ${tableResult.error}`);

    // json format - percent should be clamped
    const jsonResult = runAmilTools('progress json', tmpDir);
...
describe('todo complete command', () => {
  ...
  test('moves todo from pending to completed', () => {
    ...
    const result = runAmilTools('todo complete add-dark-mode.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails for nonexistent todo', () => {
    const result = runAmilTools('todo complete nonexistent.md', tmpDir);
...
describe('scaffold command', () => {
  ...
  test('scaffolds context file', () => {
    ...
    const result = runAmilTools('scaffold context --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds UAT file', () => {
    ...
    const result = runAmilTools('scaffold uat --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds verification file', () => {
    ...
    const result = runAmilTools('scaffold verification --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds phase directory', () => {
    const result = runAmilTools('scaffold phase-dir --phase 5 --name User Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('generate-slug command', () => {
  ...
  test('converts normal text to slug', () => {
    const result = runAmilTools('generate-slug "Hello World"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('strips special characters', () => {
    const result = runAmilTools('generate-slug "Test@#$%^Special!!!"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('preserves numbers', () => {
    const result = runAmilTools('generate-slug "Phase 3 Plan"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('strips leading and trailing hyphens', () => {
    const result = runAmilTools('generate-slug "---leading-trailing---"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails when no text provided', () => {
    const result = runAmilTools('generate-slug', tmpDir);
...
describe('current-timestamp command', () => {
  ...
  test('date format returns YYYY-MM-DD', () => {
    const result = runAmilTools('current-timestamp date', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('filename format returns ISO without colons or fractional seconds', () => {
    const result = runAmilTools('current-timestamp filename', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('full format returns full ISO string', () => {
    const result = runAmilTools('current-timestamp full', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('default (no format) returns full ISO string', () => {
    const result = runAmilTools('current-timestamp', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('list-todos command', () => {
  ...
  test('empty directory returns zero count', () => {
    const result = runAmilTools('list-todos', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter returns only matching todos', () => {
    ...
    const result = runAmilTools('list-todos ui', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter miss returns zero count', () => {
    ...
    const result = runAmilTools('list-todos nonexistent-area', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('verify-path-exists command', () => {
  ...
  test('existing file returns exists=true with type=file', () => {
    ...
    const result = runAmilTools('verify-path-exists test-file.txt', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('existing directory returns exists=true with type=directory', () => {
    ...
    const result = runAmilTools('verify-path-exists test-dir', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('missing path returns exists=false', () => {
    const result = runAmilTools('verify-path-exists nonexistent/path', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('absolute path resolves correctly', () => {
    ...
    const result = runAmilTools(`verify-path-exists ${absFile}`, tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails when no path provided', () => {
    const result = runAmilTools('verify-path-exists', tmpDir);
...
describe('resolve-model command', () => {
  ...
  test('known agent returns model and profile without unknown_agent', () => {
    const result = runAmilTools('resolve-model amil-planner', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('unknown agent returns unknown_agent=true', () => {
    const result = runAmilTools('resolve-model fake-nonexistent-agent', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('default profile fallback when no config exists', () => {
    ...
    const result = runAmilTools('resolve-model amil-executor', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails when no agent-type provided', () => {
    const result = runAmilTools('resolve-model', tmpDir);
...
describe('commit command', () => {
  ...
  test('skips when commit_docs is false', () => {
    ...
    const result = runAmilTools('commit "test message"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('creates real commit with correct hash', () => {
    ...
    const result = runAmilTools('commit "test: add test file" --files .planning/test-file.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('amend mode works without crashing', () => {
    ...
    const result = runAmilTools('commit "ignored" --files .planning/amend-file.md --amend', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
