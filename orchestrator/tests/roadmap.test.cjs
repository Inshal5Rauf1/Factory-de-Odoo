...
`
    ...
    const result = runAmilTools('roadmap get-phase 1', tmpDir);
...
`
    ...
    const result = runAmilTools('roadmap get-phase 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runAmilTools('roadmap get-phase 2.1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('roadmap analyze command', () => {
  ...
  test('missing ROADMAP.md returns error', () => {
    const result = runAmilTools('roadmap analyze', tmpDir);
...
describe('roadmap update-plan-progress command', () => {
  ...
  test('missing phase number returns error', () => {
    const result = runAmilTools('roadmap update-plan-progress', tmpDir);
...
`
    ...
    const result = runAmilTools('roadmap update-plan-progress 99', tmpDir);
