...
describe('init commands', () => {
  ...
  test('init execute-phase returns file paths', () => {
    ...
    const result = runAmilTools('init execute-phase 03', tmpDir);
  ...
  test('init plan-phase returns file paths', () => {
    ...
    const result = runAmilTools('init plan-phase 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init progress returns file paths', () => {
    const result = runAmilTools('init progress', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init phase-op returns core and optional phase file paths', () => {
    ...
    const result = runAmilTools('init phase-op 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init plan-phase extracts phase_req_ids from ROADMAP', () => {
    ...
    const result = runAmilTools('init plan-phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init execute-phase extracts phase_req_ids from ROADMAP', () => {
    ...
    const result = runAmilTools('init execute-phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitTodos', () => {
  ...
  test('empty pending dir returns zero count', () => {
    ...
    const result = runAmilTools('init todos', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter returns only matching todos', () => {
    ...
    const result = runAmilTools('init todos backend', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter miss returns zero count', () => {
    ...
    const result = runAmilTools('init todos nonexistent', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitMilestoneOp', () => {
  ...
  test('no phase directories returns zero counts', () => {
    const result = runAmilTools('init milestone-op', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitPhaseOp fallback', () => {
  ...
  test('normal path with existing directory', () => {
    ...
    const result = runAmilTools('init phase-op 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fallback to ROADMAP when no directory exists', () => {
    ...
    const result = runAmilTools('init phase-op 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('neither directory nor roadmap entry returns not found', () => {
    ...
    const result = runAmilTools('init phase-op 99', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitQuick', () => {
  ...
  test('with description generates slug and task_dir', () => {
    const result = runAmilTools('init quick "Fix login bug"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('without description returns null slug and task_dir', () => {
    const result = runAmilTools('init quick', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('next number increments from existing entries', () => {
    ...
    const result = runAmilTools('init quick "New task"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('long description truncates slug to 40 chars', () => {
    const result = runAmilTools('init quick "This is a very long description that should get truncated to forty characters maximum"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitMapCodebase', () => {
  ...
  test('no codebase dir returns empty', () => {
    const result = runAmilTools('init map-codebase', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitNewProject', () => {
  ...
  test('greenfield project with no code', () => {
    const result = runAmilTools('init new-project', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('cmdInitNewMilestone', () => {
  ...
  test('returns expected fields', () => {
    const result = runAmilTools('init new-milestone', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('file existence flags reflect actual state', () => {
    ...
    const result1 = runAmilTools('init new-milestone', tmpDir);
    ...
    const result2 = runAmilTools('init new-milestone', tmpDir);
