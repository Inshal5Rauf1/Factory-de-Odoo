...
const { cmdPhaseComplete } = require('./phase-complete.cjs');
...
function cmdPhaseAdd(cwd, description, raw) {
  ...
  // Build phase entry
  const phaseEntry = `\n### Phase ${newPhaseNum}: ${description}\n\n**Goal:** [To be planned]\n**Requirements**: TBD\n**Depends on:** Phase ${maxPhase}\n**Plans:** 0 plans\n\nPlans:\n- [ ] TBD (run /amil:plan-phase ${newPhaseNum} to break down)\n`;
...
function cmdPhaseInsert(cwd, afterPhase, description, raw) {
  ...
  // Build phase entry
  const phaseEntry = `\n### Phase ${decimalPhase}: ${description} (INSERTED)\n\n**Goal:** [Urgent work - to be planned]\n**Requirements**: TBD\n**Depends on:** Phase ${afterPhase}\n**Plans:** 0 plans\n\nPlans:\n- [ ] TBD (run /amil:plan-phase ${decimalPhase} to break down)\n`;
...
function cmdPhaseRemove(cwd, targetPhase, options, raw) {
  ...
  if (isDecimal) {
    ...
    } catch { /* decimal renumbering may fail */ }
    ...
    } catch { /* integer renumbering may fail */ }
  }
