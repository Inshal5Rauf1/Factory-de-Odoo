<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates amil-phase-researcher, amil-planner, and amil-plan-checker agents with a revision loop (max 3 iterations).
</purpose>
...
**If `planning_exists` is false:** Error — run `/amil:new-project` first.
...
If "Run discuss-phase first": Display `/amil:discuss-phase {X}` and exit workflow.
...
**If found:**
1. Read template: `~/.claude/amil/templates/VALIDATION.md`
...
1. Re-run: `/amil:plan-phase {PHASE} --research`
2. Disable Nyquist in config
3. Continue anyway (plans fail Dimension 8)

Proceed to Step 8 only if user selects 2 or 3.

## 8. Spawn amil-planner Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Amil ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<downstream_consumer>
Output consumed by /amil:execute-phase. Plans need:
...
## 10. Spawn amil-plan-checker Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Amil ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Amil ► AUTO-ADVANCING TO EXECUTE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
Skill(skill="amil:execute-phase", args="${PHASE} --auto --no-transition")
```
...
- /amil:plan-phase {X} --research — re-research first
...
- [ ] amil-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] amil-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] amil-plan-checker spawned with CONTEXT.md
