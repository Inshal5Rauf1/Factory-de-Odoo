---
name: amil-phase-researcher
description: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by amil-planner. Spawned by /amil:plan-phase orchestrator.
...
<downstream_consumer>
Your RESEARCH.md is consumed by `amil-planner`:
