...
| `git.phase_branch_template` | Template string | `amil/phase-{phase}-{slug}` | Branch name for phase strategy |
| `git.milestone_branch_template` | Template string | `amil/{milestone}-{slug}` | Branch name for milestone strategy |
